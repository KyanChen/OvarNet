...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='Collect', keys=['img', 'img_key']),
        ])
]
...
data = dict(
    ...
    test=dict(
        samples_per_gpu=32,
        type='RPNOnCC3MDataset',
        keys_file='/data/kyanchen/prompt/attributes/CC/train_CC_keys.json',
        pipeline=test_pipeline)
)
