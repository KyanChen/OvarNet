...
model = dict(
    ...
    noneed_train_names=['prompt_catephrase_learner.token_emb'],
    # img_backbone=dict(
    #     type='ResNet',
    #     depth=50,
    #     num_stages=4,
    ...
    #     precision='fp32',
    # ),
    prompt_catephrase_learner=dict(
        type='PromptPhases',
        prompt_config=dict(
            n_prompt=8,
            att_position='mid',
...
dataset_type = 'LSARPNAttributeDataset'
...
test_box_given_pipeline = [
    ...
    dict(type='MultiScaleFlipAug',
         ...
         transforms=[
            ...
            dict(type='ImageToTensor', keys=['img']),
            dict(type='Collect', keys=['img', 'gt_bboxes', 'phases'])
        ]
    )
]
