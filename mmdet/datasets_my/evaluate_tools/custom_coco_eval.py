...
class CustomCOCOEvaluator(COCOEvaluator):
    def _derive_coco_results(self, coco_eval, iou_type, class_names=None, categories_seen_unseen={}):
        """
        ...
        seen_names = set([x for x in categories_seen_unseen['seen']])
        unseen_names = set([x for x in categories_seen_unseen['unseen']])
