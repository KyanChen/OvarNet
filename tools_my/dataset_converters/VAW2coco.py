...
def cvt_annotations(json_data, out_file):
    annotations = cvt_to_coco_json(json_data)
...
def main():
    inpath = '/data/kyanchen/prompt/data/VAW'
    pattern = 'test'
    json_file = inpath + '/' + pattern + '.json'
    json_data = json.load(open(json_file, 'r'))

    cvt_annotations(json_data, json_file.replace(pattern + '.json', pattern + '_coco.json'))
    print('Done!')
