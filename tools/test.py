...
def parse_args():
    ...
    parser.add_argument('--config', default='../configs_my/OvarNet/Op2_1_OvarNetP_w_KD.py', help='test config file path')
    # parser.add_argument('--checkpoint', default='', help='checkpoint file')
    parser.add_argument('--checkpoint', default='results/EXP20230210_1/epoch_50.pth', help='checkpoint file')
    # parser.add_argument('--checkpoint', default='/data/kyanchen/prompt/pretrain/faster_rcnn_x101_64x4d_fpn_mstrain_3x_coco_20210524_124528-26c63de6.pth', help='checkpoint file')
...
def main():
    ...
    if args.checkpoint is not None and os.path.exists(args.checkpoint):
        ...
        checkpoint = {}
        print('No loading model', flush=True)
